...
set SOURCE_HEX=D:\github\solar-tracking-system-internal\build\Objects\solar_tracking_system_internal_acc.hex
...
set DEFINES_FILE=D:\github\solar-tracking-system-internal\src\app\core\main\defines.h
